...
async def run_ble_client(device, callback):
    ...
    async with BleakClient(device, disconnected_callback=
        ...
        await pmd.start_streaming('SDK') #Requesting SDK mode for wider PPG settings
...
async def main():
    ...
    print(" ('PPG', tstamp, [(ppg0_1,ppg1_1,ppg2_1,ambient_1),(ppg0_2,ppg1_2,ppg2_2,ambient_2),...,(ppg0_n,ppg1_n,ppg2_n,ambient_n)])")
